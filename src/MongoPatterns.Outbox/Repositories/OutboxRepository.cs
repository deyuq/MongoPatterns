...
/// <summary>
/// Specialized repository for outbox messages that supports microservice-specific collection prefixes
/// </summary>
public class OutboxRepository : MongoRepository<OutboxMessage>
{
