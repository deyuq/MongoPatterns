...
public class TransactionExampleController : ControllerBase
{
    ...
    private readonly ILogger<TransactionExampleController> _logger;

    /// <summary>
    /// Creates a new instance of the TransactionExampleController
    /// </summary>
    public TransactionExampleController(
        IUnitOfWork unitOfWork,
        IOutboxService outboxService,
        ILogger<TransactionExampleController> logger)
    {
